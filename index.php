      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <img class="img-fluid mb-5" src="http://localhost:8080/wp-content/themes/theme/img/portfolio/cabin.png" alt="">
      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <img class="img-fluid mb-5" src="http://localhost:8080/wp-content/themes/theme/img/portfolio/cake.png" alt="">
      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <img class="img-fluid" src="http://localhost:8080/wp-content/themes/theme/img/portfolio/circus.png" alt="">
            <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</p>
            <a class="btn btn-primary btn-lg rounded-pill portfolio-modal-dismiss" href="#">
              <i class="fa fa-close"></i>
              Close Project</a>
      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <img class="img-fluid" src="http://localhost:8080/wp-content/themes/coding-theme/img/portfolio/game.png" alt="">
      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <img class="img-fluid" src="http://localhost:8080/wp-content/themes/coding-theme/img/portfolio/safe.png" alt="">
      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <img class="img-fluid" src="http://localhost:8080/wp-content/themes/coding-theme/img/portfolio/submarine.png" alt="">
            <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</p>
            <a class="btn btn-primary btn-lg rounded-pill portfolio-modal-dismiss" href="#">
              <i class="fa fa-close"></i>
              Close Project</a>
